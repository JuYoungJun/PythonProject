...
def get_top_tracks_by_country(client_id, client_secret, country_code):
    """
    ...
    try:
        ...
        offset = 0
        playlist_results = sp.featured_playlists(country=country_code, limit=1)
        ...
        if e.http_status == 429:
            ...
            return get_top_tracks_by_country(client_id, client_secret, country_code)
        else:
...
if __name__ == "__main__":
    ...
    for country in countries:
        ...
        country_data = get_top_tracks_by_country(CLIENT_ID, CLIENT_SECRET, country)
